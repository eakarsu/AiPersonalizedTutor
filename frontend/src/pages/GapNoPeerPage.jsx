...
export default function GapNoPeerPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-peer/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No '/peer</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No /peer-comparison-anonymized (benchmark against cohort)</p>
