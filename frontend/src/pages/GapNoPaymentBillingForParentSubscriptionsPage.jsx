...
// Gap (Non-AI): No payment/billing for parent subscriptions
// No payment/billing for parent subscriptions
import React, { useState } from 'react';

export default function GapNoPaymentBillingForParentSubscriptionsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-billing-for-parent-subscriptions/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No payment/billing for parent subscriptions</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No payment/billing for parent subscriptions</p>
