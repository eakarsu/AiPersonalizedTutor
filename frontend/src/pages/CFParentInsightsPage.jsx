...
// Parent insights: Dashboard shows student strengths/weaknesses; AI generates learning plans with time estimates
import React, { useState } from 'react';

export default function CFParentInsightsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-parent-insights/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Parent insights</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Parent insights: Dashboard shows student strengths/weaknesses; AI generates learning plans with time estimates</p>
