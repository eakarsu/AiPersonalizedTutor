...
// Custom Feature: Content recommendation
// Content recommendation: AI analyzes student learning style (visual, kinesthetic, reading); recommends resources
import React, { useState } from 'react';

export default function CFContentRecommendationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-content-recommendation/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Content recommendation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Content recommendation: AI analyzes student learning style (visual, kinesthetic, reading); recommends resources</p>
