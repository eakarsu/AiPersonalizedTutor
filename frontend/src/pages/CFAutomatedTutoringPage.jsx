...
// Custom Feature: Automated tutoring
// Automated tutoring: Avatar/chatbot provides hints and explanations when student is stuck
import React, { useState } from 'react';

export default function CFAutomatedTutoringPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-automated-tutoring/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Automated tutoring</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Automated tutoring: Avatar/chatbot provides hints and explanations when student is stuck</p>
