...
export default function GapNoTeacherPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-teacher/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No '/teacher</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No /teacher-assistant-ai (help teachers grade/respond to many students)</p>
