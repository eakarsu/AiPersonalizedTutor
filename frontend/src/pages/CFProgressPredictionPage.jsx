...
// Custom Feature: Progress prediction
// Progress prediction: ML forecasts likelihood of passing exams; recommends study intensity
import React, { useState } from 'react';

export default function CFProgressPredictionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-progress-prediction/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Progress prediction</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Progress prediction: ML forecasts likelihood of passing exams; recommends study intensity</p>
